...
// $('*:not(h2,p)').css('border', '1px solid red'); Исключает из найденных элементов srlrctor
// $('li:odd').css('border', '1px solid red'); Четные найденные элементы
// $('li:even').css('border', '1px solid red'); Нечетные найденные элементы
// $('li:gt(0)').css('border', '1px solid red'); Элементы чей порядковый номер больше п
// $('li:lt(3)').css('border', '1px solid red'); Элементы чей порядковый номер меньше п
// $('*:header').css('border', '1px solid red'); Только те элементы, которые являются заголовками
// $('li:animated').css('border', '1px solid red'); Только те элементы, которые задействовны в анимации
